...
export class OrganPetitionService {
  ...
  private _lastPatientByIdentification: WritableSignal<PatientResponse | undefined> = signal<
    PatientResponse | undefined
  >(undefined);
  lastPatientByIdentification = this._lastPatientByIdentification.asReadonly();

  private _lastPatientById: WritableSignal<PatientResponse | undefined> = signal<
    PatientResponse | undefined
  >(undefined);
  lastPatientById = this._lastPatientById.asReadonly();

  private _draftPetitions: WritableSignal<OrganPetitionResponse[]> = signal<
    OrganPetitionResponse[]
  >([]);
  draftPetitions = this._draftPetitions.asReadonly();

  private _cancelledPetitions: WritableSignal<OrganPetitionResponse[]> = signal<
    OrganPetitionResponse[]
  >([]);
  cancelledPetitions = this._cancelledPetitions.asReadonly();

  private _waitingPetitions: WritableSignal<OrganPetitionResponse[]> = signal<
    OrganPetitionResponse[]
  >([]);
  waitingPetitions = this._waitingPetitions.asReadonly();

  private _assignedPetitions: WritableSignal<OrganPetitionResponse[]> = signal<
    OrganPetitionResponse[]
  >([]);
...
savePetition(data: IOrganPetition): Observable<boolean> {
    ...
    return from(this.encryptService.encrypt(JSON.stringify(body))).pipe(
      switchMap((encryptedResult: string) => {
        ...
        return this.http
          .post<OrganPetitionResponse>(`${API_URL}/api/v1/organ-petitions/create`, body)
          .pipe(
  ...
  updatePetition(data: OrganPetitionUpdate) {
    ...
    return from(this.encryptService.encrypt(JSON.stringify(body))).pipe(
      switchMap((encryptedResult: string) => {
        ...
        return this.http
          .post<OrganPetitionResponse>(`${API_URL}/api/v1/organ-petitions/update`, body)
          .pipe(
            map((response) => this.handleSuccessSave(response)),
            catchError((error) => this.handleErrorSave(error)),
          );
  ...
  deletePetition(idPetition: number) {
    ...
    return from(this.encryptService.encrypt(JSON.stringify(body))).pipe(
      switchMap((encryptedResult: string) => {
        ...
        return this.http
          .post<OrganPetitionResponse>(`${API_URL}/api/v1/organ-petitions/delete`, body)
          .pipe(
  ...
  acceptPetition(idPetition: number): Observable<boolean> {
    ...
    return from(this.encryptService.encrypt(JSON.stringify(body))).pipe(
      switchMap((encryptedResult: string) => {
        ...
        return this.http
          .patch<OrganPetitionResponse>(`${API_URL}/api/v1/organ-petitions/accept`, body)
          .pipe(
  ...
  assingPetition(idPetition: number): Observable<boolean> {
    ...
    return from(this.encryptService.encrypt(JSON.stringify(body))).pipe(
      switchMap((encryptedResult: string) => {
        ...
        return this.http
          .patch<OrganPetitionResponse>(`${API_URL}/api/v1/organ-petitions/check`, body)
          .pipe(
  ...
  cancelPetition(idPetition: number): Observable<boolean> {
    ...
    return from(this.encryptService.encrypt(JSON.stringify(body))).pipe(
      switchMap((encryptedResult: string) => {
        ...
        return this.http
          .patch<OrganPetitionResponse>(`${API_URL}/api/v1/organ-petitions/cancel`, body)
          .pipe(
  ...
  loadDraftPetitions(): Observable<boolean> {
    return this.http
      .get<OrganPetitionResponse[]>(`${API_URL}/api/v1/organ-petitions/state/DRAFT`)
      .pipe(
  ...
  loadAssignedPetitions(): Observable<boolean> {
    return this.http
      .get<OrganPetitionResponse[]>(`${API_URL}/api/v1/organ-petitions/state/ASSIGNED_ORGAN`)
      .pipe(
        map((assignedPetitions) =>
          this.handleSuccessLoad(assignedPetitions, this._assignedPetitions),
        ),
  ...
  loadCancelledPetitions(): Observable<boolean> {
    return this.http
      .get<OrganPetitionResponse[]>(`${API_URL}/api/v1/organ-petitions/state/CANCELLED`)
      .pipe(
        map((cancelledPetitions) =>
          this.handleSuccessLoad(cancelledPetitions, this._cancelledPetitions),
        ),
  ...
  loadWaitingPetitions(): Observable<boolean> {
    return this.http
      .get<OrganPetitionResponse[]>(`${API_URL}/api/v1/organ-petitions/state/WAITING`)
      .pipe(
  ...
  private handleSuccessLoad(
    petitions: OrganPetitionResponse[],
    signalToSet: WritableSignal<OrganPetitionResponse[]>,
  ) {
  ...
  private handleErrorGetPatientByIdentification(error: any) {
    ...
    console.error(
      'Catched error on GET petition to obtain patient by identification: ',
      errMessage,
    );
